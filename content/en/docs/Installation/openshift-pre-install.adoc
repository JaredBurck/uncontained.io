...
linkTitle: "OpenShift Pre-Install Validation Checklist"
weight: 3
description: >
  Recommended reading for pre-installation preparations for installations with cloud native technologies and development techniques.
