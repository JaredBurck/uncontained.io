...
linkTitle: "OpenShift Templates IaC"
weight: 5
description: >
  Recommended reading for Using OpenShift Templates in a Configuration as Code Model with cloud native technologies and development.
